...
export default function Dashboard() {
  ...
  return (
    <div className="page dashboard">
      ...
      {/* Fila: bienvenida + KPIs a la derecha */}
      <div className="dash-hero">
        ...
        <div className="kpi">
          <div className="kpi__icon"><FaArchive /></div>
          <div className="kpi__num">{itemsCount.toLocaleString()}</div>
          <div className="kpi__label">Items registrados</div>
        </div>
      ...
      <div className="card">
        <div className="card__header">
          ...
          <a className="card__link" href="/historial">Ver historial</a>
        </div>
